...
export default function TechStack() {
  return (
    <div className="bg-gray- py-12 sm:py-12">
      <div className="mx-auto max-w-7xl px-6 lg:px-8">
        <h2 className="text-center text-2xl md:text-4xl font-semibold leading-8 text-white">
          Tech stack
        </h2>
        <div className="mx-auto mt-10 grid max-w-lg grid-cols-4 items-center gap-x-8 gap-y-10 sm:max-w-xl sm:grid-cols-6 sm:gap-x-10 lg:mx-0 lg:max-w-none lg:grid-cols-5">
          <img
            className="col-span-2 max-h-12 w-full object-contain lg:col-span-1 bg-gray-200 rounded-xl"
          ...
          <img
            className="col-span-2 max-h-12 w-full object-contain lg:col-span-1 bg-gray-200 rounded-xl"
            src="https://www.vectorlogo.zone/logos/elixir-lang/elixir-lang-ar21.svg"
            alt="Transistor"
            width="158"
            height="48"
          ></img>
          ...
          <img
            className="col-span-2 max-h-12 w-full object-contain lg:col-span-1 bg-gray-200 rounded-xl"
            src="https://blixtdev.com/content/images/size/w2000/2023/02/1WvDl2WlPs7cR8TTBvrjpyw.png"
            alt="Transistor"
            width="158"
            height="48"
          ></img>
        ...
        <h2 className="text-center text-lg font-semibold leading-8 text-white mt-10">
          And many more...
        </h2>
      </div>
    </div>
